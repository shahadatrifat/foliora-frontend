...
import { FaBookOpen, FaCheckCircle, FaBookmark } from "react-icons/fa"; 
...
const DashboardStats = ({ ReadingCount, ReadCount, WantToReadCount }) => {
  return (
    ...
    >
      {/* Reading */}
      <div className="flex flex-col items-center text-center p-6 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-xl shadow  transition-all">
